...
public class TestDatabase {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        /*Calls use catch the exception. Definitions should throw in the declaration
        * However a declaration could need to throw within using a method that needs
        * to catch on call. #confusingMyself*/
        try {
            db.load();
        } catch (SQLException e) {
            e.printStackTrace();
