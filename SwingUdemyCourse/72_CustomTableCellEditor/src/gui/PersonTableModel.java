    ...
    public boolean isCellEditable(int row, int col) {
        ...
        switch (col) {
            case 1:
                return true;
            case 4:
                return true; // make sure it's editable
            case 5:
    ...
    public void setValueAt(Object aValue, int row, int col) {
        ...
        switch (col) {
            case 1:
                ...
                break;
            case 4:
                person.setEmpCat((EmploymentCategory) aValue); //More value sticking
                break;
            case 5:
    ...
    public Class<?> getColumnClass(int col) {
        switch (col) {
            ...
            case 3:
                return String.class;
            case 4:
                return EmploymentCategory.class; //Employment Category custom renderer 71
            case 5:
